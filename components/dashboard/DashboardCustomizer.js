...
export default function DashboardCustomizer() {
    ...
    const widgets = [
        ...
        { id: 'tempChart', label: 'Temperature Chart', icon: '🌡️' },
        { id: 'cpuChart', label: 'CPU Chart', icon: '📈' },
        { id: 'trafficChart', label: 'Traffic History', icon: '📊' },
    ];
    ...
    return (
        <>
            ...
            <motion.button
                ...
                className="fixed right-6 bottom-24 md:bottom-6 z-40 p-3 rounded-full bg-white/30 dark:bg-gray-900/30 backdrop-blur-xl shadow-lg border border-white/20 dark:border-gray-700 text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed right-0 top-0 bottom-0 w-80 bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl shadow-2xl z-50 border-l border-gray-200 dark:border-gray-800 p-6 overflow-y-auto"
                        >
