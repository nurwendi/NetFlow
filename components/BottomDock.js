...
export default function BottomDock() {
    ...
    const navItems = [
        { href: '/', icon: Home, label: t('sidebar.dashboard'), roles: ['admin', 'partner', 'viewer', 'customer'] },
        { href: '/billing', icon: CreditCard, label: t('sidebar.billing'), roles: ['admin', 'partner'] },
        { href: '/users', icon: Users, label: t('sidebar.users'), roles: ['admin', 'partner', 'viewer'] },
        { href: '/active', icon: Activity, label: t('sidebar.activeConnections'), roles: ['admin', 'partner', 'viewer'] },
        { href: '/offline', icon: WifiOff, label: 'Offline', roles: ['admin', 'partner', 'viewer'] },
        ...
        { href: '/app-settings', icon: Settings, label: t('sidebar.appSettings'), roles: ['admin', 'partner', 'viewer'] },
        { href: '/theme-settings', icon: Palette, label: t('sidebar.themeSettings'), roles: ['admin', 'partner', 'viewer'] },
        { href: '/notifications', icon: Bell, label: t('sidebar.notifications'), roles: ['admin', 'partner', 'viewer', 'customer'] },
